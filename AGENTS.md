...
2. Validate locally: `cargo fmt --check && cargo clippy --all-targets --all-features && cargo test`.
3. Commit and push to main: `git commit -am "chore: bump version to vX.Y.Z" && git push origin main`.
